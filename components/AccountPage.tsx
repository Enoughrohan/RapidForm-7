  ...
  return (
    <div style={{ overflowY: 'auto', height: 'calc(100vh - 60px)', paddingBottom: 88 }}>
      <div style={{
        ...
        <div style={{ fontFamily: "'DM Serif Display', serif", fontSize: 21, color: '#fff', marginBottom: 3 }}>
          {name}
        </div>
      ...
      <div style={{
        ...
        marginTop: -18, padding: '22px 18px 8px', minHeight: '100%',
      }}>
          ...
          <div key={title} style={{ marginBottom: 20 }}>
            ...
            {items.map(({ icon: Icon, label, color, bg }) => (
              <div key={label} style={{
                ...
                padding: '13px 14px', background: '#F8F4ED',
        ...
        <div onClick={handleLogout} style={{
          display: 'flex', alignItems: 'center', gap: 12,
          padding: '13px 14px', background: '#FFF1F2',
          borderRadius: 12, marginBottom: 8, cursor: 'pointer',
        }}>
          <div style={{
            width: 38, height: 38, borderRadius: 10,
